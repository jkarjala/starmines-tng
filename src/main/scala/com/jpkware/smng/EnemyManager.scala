...
class EnemyManager(game: Game, randomSafePosition: (Sprite) => Unit) {
  ...
  val rules = Seq(
    ...
    Rule(Splitter.spawn, "4atom", 16, 12, 400, minL=15, maxL=MAX, modL=3, minC=1, maxC=5, div=3, spd=60, Seq("1atom","16","12","4")),
    Rule(Splitter.spawn, "4atomb", 16, 12, 400, minL=16, maxL=MAX, modL=3, minC=1, maxC=5, div=3, spd=60, Seq("1atom","16","12","4")),
    Rule(Splitter.spawn, "4atomc", 16, 12, 400, minL=17, maxL=MAX, modL=3, minC=1, maxC=5, div=3, spd=60, Seq("1atom","16","12","4")),
    ...
    Rule(Producer.spawn, "4boxa", 16, 20, 1000, minL=20, maxL=MAX, modL=2, minC=1, maxC=5, div=10, spd=10, Seq("1boxa","16","12","4","30000")),
    Rule(Producer.spawn, "4boxb", 16, 20, 1000, minL=21, maxL=MAX, modL=2, minC=1, maxC=5, div=10, spd=10, Seq("1boxb","16","12","4", "30000")),
