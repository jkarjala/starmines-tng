...
class EnemyManager(game: Game, randomSafePosition: (Sprite) => Unit) {
  ...
  val rules = Seq(
    ...
    Rule(PathMine.spawn, "torusa", 32, 18, 150, minL=2, maxL=9, modL=1, minC=2, maxC=8, div=1, spd=80, Seq("3ALz9i9i")),
    Rule(PathMine.spawn, "torusb", 32, 18, 150, minL=10, maxL=19, modL=1, minC=2, maxC=8, div=1, spd=80, Seq("8ALx9ix9iax9ix9id")),
    Rule(PathMine.spawn, "torusc", 32, 18, 150, minL=20, maxL=29, modL=1, minC=2, maxC=8, div=1, spd=80, Seq("8ALz9iz9iz9iz9iz9iz9iaz9iz9iz9iz9iz9iz9id")),

    Rule(PathWorm.spawn, "balla", 32, 12, 250, minL=5, maxL=11, modL=1, minC=1, maxC=5, div=1, spd=50, Seq("6ALx9ix9iz9i", "2")),
    Rule(PathWorm.spawn, "ballb", 32, 12, 250, minL=10, maxL=14, modL=1, minC=1, maxC=5, div=1, spd=60, Seq("6ALz9i2z9i9ix", "2")),
    Rule(PathWorm.spawn, "ballc", 32, 12, 250, minL=15, maxL=24, modL=1, minC=3, maxC=5, div=1, spd=70, Seq("6AL9ix9ix9iz", "3")),

    Rule(PathWorm.spawn, "balla", 32, 12, 250, minL=25, maxL=34, modL=1, minC=3, maxC=5, div=1, spd=60, Seq("6ALx9ix9iz9i", "4")),
    Rule(PathWorm.spawn, "ballb", 32, 12, 250, minL=35, maxL=44, modL=1, minC=3, maxC=5, div=1, spd=70, Seq("6ALz9i2z9i9ix", "4")),
    Rule(PathWorm.spawn, "ballc", 32, 12, 250, minL=45, maxL=54, modL=1, minC=3, maxC=5, div=1, spd=80, Seq("6AL9ix9ix9iz", "4")),

    Rule(PathWorm.spawn, "balla", 32, 12, 250, minL=55, maxL=80, modL=3, minC=2, maxC=5, div=5, spd=60, Seq("6ALx9ix9iz9i", "5")),
    Rule(PathWorm.spawn, "ballb", 32, 12, 250, minL=75, maxL=100, modL=3, minC=2, maxC=5, div=5, spd=80, Seq("6ALz9i2z9i9ix", "5")),
    Rule(PathWorm.spawn, "ballc", 32, 12, 250, minL=95, maxL=MAX, modL=3, minC=2, maxC=5, div=5, spd=90, Seq("6AL9ix9ix9iz", "6")),
    ...
    Rule(XYShooter.spawn, "xshoot",  32, 8, 500, minL=20, maxL=MAX, modL=1, minC=1, maxC=4, div=4, spd=100, Seq("1","0", "800")),
    Rule(XYShooter.spawn, "yshoot",  32, 8, 500, minL=20, maxL=MAX, modL=1, minC=1, maxC=4, div=4, spd=100, Seq("0","1", "800")),

    Rule(Splitter.spawn, "2atom", 16, 12, 400, minL=10, maxL=40, modL=3, minC=3, maxC=5, div=1, spd=60, Seq("1atom","16","12","2")),
    Rule(Splitter.spawn, "2atomb", 16, 12, 400, minL=11, maxL=41, modL=3, minC=3, maxC=5, div=1, spd=60, Seq("1atom","16","12","2")),
    Rule(Splitter.spawn, "2atomc", 24, 12, 400, minL=12, maxL=42, modL=3, minC=3, maxC=5, div=1, spd=60, Seq("1atom","16","12","2")),
    ...
    Rule(Producer.spawn, "4boxa", 16, 20, 1000, minL=20, maxL=70, modL=2, minC=1, maxC=5, div=10, spd=10, Seq("1boxa","16","12","4","30000")),
    Rule(Producer.spawn, "4boxb", 16, 20, 1000, minL=71, maxL=MAX, modL=2, minC=2, maxC=5, div=10, spd=20, Seq("1boxb","16","12","4", "15000")),
